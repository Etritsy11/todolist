...
def create_to_do(request):
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/createtodo.html', {'form': TodoForm(), 'error': 'Invalid data entered. Try again'})
...
def view_todo(request, todo_pk):
    ...
    if request.method == 'GET':
        ...
        try:
            ...
            return render(request, 'todo/viewtodo.html', {'todo': todo, 'form': form, 'error': 'Invalid information'})
